<?php
	...
	$order = "SELECT * FROM pmorders LEFT outer join pmusers on pmorders.pmuserid = pmusers.pmuserid WHERE pmorders.pmorderdate >= CURDATE() ORDER BY pmorders.pmorderdate  desc";
	$orderresult = mysqli_query($link, $order);
	$row = mysqli_fetch_all($orderresult,MYSQLI_ASSOC);

	$previousorder = "SELECT * FROM pmorders LEFT outer join pmusers on pmorders.pmuserid = pmusers.pmuserid WHERE pmorders.pmorderdate < CURDATE() ORDER BY pmorders.pmorderdate  desc";
					  		...
					  		<div class="tab-pane fade show active" id="current-order" role="tabpanel" aria-labelledby="pickup-tab">
					  			<div class="container">
									...
									<div class="row">
							 			...
							 			<div><?php echo "Floor: ". $value['pmusermobile'];?></div>
							 			</div>
							 			<div class="col-md-3">
					  			...
					  			<div class="container">
					  				<div class="row">
										...
										<h5>Drop Location</h5>
							 			...
							 			<div class="col-md-4"><h5>Movables :</h5></div>
							 			<br>
								 	</div>
